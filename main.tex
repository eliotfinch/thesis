...
First and foremost I would like to thank my supervisor, Chris Moore, for all the guidance and support. 
I’ll always be grateful for the time you have invested in me, and for your patience and understanding.
I would also like to thank Alberto Vecchio for introducing me to gravitational-wave astronomy, and for being a caring head of a brilliant research group. 
...
Thank you to Aaron and Marc for all the laughs, and for all the years of friendship. % always being there.
...
In particular, it is known that the extrapolation technique does not capture GW memory effects, and post-processing must be performed to ensure the remnant BH is in a suitable frame. 
...
% My time studying physics in Birmingham has coincided with the birth of GW astronomy. 
% As a community, we have rapidly progressed from the first direct detection of GWs to producing large-scale catalogs that analyse scores of new events at a time. 
% With the fourth LIGO/Virgo observing run due to start imminently, hundreds more events are expected in the next few years. 
% Therefore, there will be ample scope to apply the tools and techniques I have developed during this PhD to many more observations in the near future.

% In conclusion, as gravitational-wave astronomy continues to advance and our detection capabilities improve, we can anticipate an exciting future with an abundance of new signals that will unveil the mysteries of the universe.

% In conclusion, the field of gravitational-wave astronomy is rapidly evolving, and we can expect to see many more exciting discoveries in the coming years. With the continued development of sensitive detectors like LIGO, Virgo, and KAGRA, as well as the construction of new facilities like LISA and Einstein Telescope, we will be able to detect gravitational waves from an increasing variety of astrophysical sources, including binary black holes, neutron stars, and possibly even cosmic strings. The analysis and interpretation of these signals will provide unprecedented insights into the nature of gravity, the properties of matter under extreme conditions, and the evolution of the universe as a whole. In short, the future of gravitational-wave astronomy is bright, and we are poised to make many more groundbreaking discoveries in the years to come.
