...
By working in the frequency domain, we can use the standard, and now very mature, GW data analysis pipelines (our analysis pipeline borrows from the public \texttt{Bilby} package~\cite{Ashton:2018jfp}).
