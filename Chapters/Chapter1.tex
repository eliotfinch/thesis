...
Eq.~\ref{ch1:eq:time_to_merger} is valid in the quasi-circular orbit regime; it can be derived by equating the time derivative of the orbital energy of a binary system (\comment{give expression?}) to (negative) the GW luminosity Eq.~\ref{ch1:eq:gw_luminosity}, where the quadrupolar moment is most easily calculated using the equivalent one-body problem with a reduced mass.
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.75\columnwidth]{Introduction/ringdown_waveform.pdf}
