...
%     \item Some further work on the geodesic stability~\cite{Cardoso:2008bp}.
...
%     \item Allows study of BHs in theories beyond GR, for example~\cite{Blazquez-Salcedo:2016enn}.
%     \item Or for constraining charge in Kerr-Newman~\cite{Cardoso:2016olt, Wang:2021uuh} (but see also~\cite{Carullo:2021oxn} where a more sophisticated analysis was done).
% \end{itemize}
...
Below we take an axisymmetric spacetime and show how one arrives at expressions for the QNM frequencies.
