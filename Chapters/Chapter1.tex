...
To understand the response of a interferometer to incoming GWs, consider a setup where the interferometer arms are aligned with the $x$- and $y$-axes such that the beam-splitter is at the origin and the mirrors are at the coordinates $(L_x,0)$ and $(0,L_y)$. \comment{Figure?}
