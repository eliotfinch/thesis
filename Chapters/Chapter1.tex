...
The testing GR companion papers for the second~\cite{LIGOScientific:2020tif} and third~\cite{LIGOScientific:2021sio} GW event catalogs featured searches for QNMs; 22
...
% Cite some important papers here? Explain what we do in this section...

% Avoid M_f notation since I use M in following subsection?
...
% This offers the opportunity for some clean tests of GR... discussed further in Section~\ref{...}
...
When enforcing these boundary conditions, only discrete values of $\omega = \omega_{\ell m n}$ satisfy Eq.~\ref{eq:fd_wave_equation}; these are the QNMs.
% Not technically true?
They are indexed by three numbers: the usual angular indices $\ell$ and $m$, % Relate back to where I've already mentioned these?
and an additional ``overtone'' index $n$.
...
% Cite the nice vibrating string paper somewhere here? https://arxiv.org/abs/gr-qc/0605118
