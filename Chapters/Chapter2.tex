...
%(although, see Ref.~\cite{Berti:2007fi} where a range of different start times are explored). 
...
For now we will assume this frame is also such that the remnant BH spin vector is aligned with the $z$-axis, but note that this won't be true in general for precessing systems.
}
...
\begin{equation}\label{ch2:eq:spheroidal_expansion}
    h = \sum_{\ell =2}^\infty \sum_{m = -\ell}^\ell \sum_{n = 0}^\infty \left[ C_{\ell m n} e^{-i \omega_{\ell m n} t} {}_{-2}S_{\ell m n}(\Omega) + C'_{\ell m n} e^{-i \omega'_{\ell m n} t} {}_{-2}S'_{\ell m n}(\Omega) \right],
\end{equation}
...
However, for completeness we describe how multimode fits can be implemented % (which has been done in the code...)
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\columnwidth]{ModellingTheRingdownFromPrecessingBlackHoleBinaries/305_mismatch_vs_t0_with_error.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\columnwidth]{ModellingTheRingdownFromPrecessingBlackHoleBinaries/305_epsilon_grid.pdf}
...
% ~\cite{Flanagan:1997sx, Berti:2007fi, Kamaretsos:2011um, London:2014cma, Carullo:2018sfu, Bhagwat:2017tkm, Giesler:2019uxc, Ota:2019bzl, Dhani:2020nik}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\columnwidth]{ModellingTheRingdownFromPrecessingBlackHoleBinaries/tEdot-t22_hist.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\columnwidth]{ModellingTheRingdownFromPrecessingBlackHoleBinaries/1856_mismatch_vs_t0_with_error_edit.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\columnwidth]{ModellingTheRingdownFromPrecessingBlackHoleBinaries/1856_epsilon_grid_alt.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\columnwidth]{ModellingTheRingdownFromPrecessingBlackHoleBinaries/1856_mismatch_vs_t0_mirror_modes_with_error_edit.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\columnwidth]{ModellingTheRingdownFromPrecessingBlackHoleBinaries/1856_epsilon_grid_mirror_modes_m5.pdf}
...
To investigate whether the choice of ringdown start time could be contributing to the wider histograms seen in Fig.~\ref{misaligned_spin_epsilon_hist} %and \ref{misaligned_spin_epsilon_hist_m10}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.75\columnwidth]{ModellingTheRingdownFromPrecessingBlackHoleBinaries/surrogate_epsilon_and_mass_ratio.pdf}
...
In this appendix we describe the numerical checks performed on the two individual simulations used in this chapter: SXS:BBH:0305, and 1856. %, and the three simulations shown in Fig.~\ref{misaligned_spin_variation}.
