...
Several early studies caution against starting too early \cite{JimenezForteza:2020cve, Bhagwat:2019dtm}.
}

Giesler et al.~\cite{Giesler:2019uxc} found that by including up to seven overtones the ringdown analysis can be started as early as the peak in the 22 mode of the strain. 
...
% Excitation factors? https://inspirehep.net/literature/1925166
...
% This work represents the first attempt to model the ringdown from NR simulations without aligned-spins.
...
% include also https://inspirehep.net/literature/2066547 ?
...
Numerical relativity expands the GW strain in the basis of (spin-weighted) spherical harmonics
...
In this appendix we describe the numerical checks performed on the 5 individual simulations used in this chapter: SXS:BBH:0305, 1856, and the three simulations shown in Fig.~\ref{misaligned_spin_variation}.
